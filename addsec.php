...
if(isset($_POST['Submit'])) {	
	...
	$result = mysqli_query($db, "INSERT INTO section (sec_name, login_id) VALUES('$sec_name', '$loginId')");
		header('location: records.php');
	} 
?>

<div class="container">
	<form action="addsec.php" method="post" name="form1">
		<div class="form-group row">
			<label for="colFormLabel" class="col-sm-2 col-form-label">section name</label>
				<div class="col-sm-5">
					<input type="text" name="sec_name" class="form-control" id="colFormLabel" required>
				</div>
		</div>
		<div class="form-group row">
